...
{
	ShellExecute(NULL, _T("open"), _T("http://www.cryptcube.cn/donate"),NULL, NULL, SW_SHOWNORMAL); 
}

void CAboutDlg::OnAppWebsite()
{
	ShellExecute(NULL, _T("open"), _T("http://www.cryptcube.cn/"),NULL, NULL, SW_SHOWNORMAL); 
}
